...
RN001 – Rumo da pista: Deve ser um número inteiro maior que 0 e menor ou igual a 360. É expresso em graus (°). Na saída, é expresso com 3 dígitos (ex.: 003°, 055°, 233°).

RN002 – Circuito: Deve ser selecionado se o circuito é padrão ou não-padrão. Se for padrão, o rumo para entrada na perna do vento é -45°, se for não-padrão, é +45°.

RN003 – Perna do vento: É o cálculo do Rumo da pista na direção contrária. Ou seja, se for entre 1 e 180, soma 180° ao Rumo da pista, e se for entre 181 a 360, diminui 180° ao Rumo da pista.
...
RN004 – Rumo de entrada da perna do vento: É a soma ou subtração de 45° na perna do vento. Se o circuito for padrão, diminui 45°, se for não-padrão, soma 45°.
...
RN005 – Posição em relação a pista: É o cálculo do rumo de entrada da perna do vento invertido. Ou seja, se o rumo de entrada da perna do vento for entre 1 e 180, soma 180°, se for entre 181 a 360, diminui 180°.
...
RN006 – Posição cardeal: Representa a posição cardeal da posição em relação a pista.
